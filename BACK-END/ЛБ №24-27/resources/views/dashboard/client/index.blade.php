...
@section('content')
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Клиенты</h3>
                <div class="nk-block-des text-soft">
                    <p>Всего {{ $response->total() }} клиентов</p>
                </div>
                    ...
                    <div class="toggle-expand-content" data-content="more-options">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt">
                                <a href="{{ route('dashboard.client.create') }}" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                <a href="{{ route('dashboard.client.create') }}" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Добавить</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="nk-block">
        <div class="nk-tb-list is-separate mb-3">
            <form class="nk-tb-item nk-tb-head" method="GET" action="{{ route('dashboard.client.index') }}">
                <div class="nk-tb-col">
                                ...
                                <div class="drodown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <ul class="link-list-opt no-bdr">
                                            <li><a href="{{ route('dashboard.client.view', ['id' => $user->id]) }}"><em class="icon ni ni-eye"></em><span>Просмотр</span></a></li>
                                            <li><a href="{{ route('dashboard.client.edit', ['id' => $user->id]) }}"><em class="icon ni ni-repeat"></em><span>Изменить</span></a></li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="{{ route('dashboard.client.destroy', ['id' => $user->id]) }}" onclick="return confirm('Вы точно хотите удалить?')">
