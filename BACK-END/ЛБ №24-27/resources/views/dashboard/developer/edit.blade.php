...
@section('content')
    <form method="POST" action="{{ route('dashboard.developer.update', ['id' => $response->id]) }}">
        @csrf
        <div class="card card-bordered card-preview">
            <div class="card-inner">
                <div class="preview-block">
                    <span class="preview-title-lg overline-title">Редактироваие разработчика</span>
                    <div class="row gy-4">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label" for="default-01">Должность</label>
                                <div class="form-control-wrap">
                ...
                <a href="{{ route('dashboard.developer.index') }}" class="btn btn-light">Назад</a>
            </div>
        </div>
    </form>
@endsection
