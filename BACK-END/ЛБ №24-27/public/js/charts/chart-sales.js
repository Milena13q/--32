!(function (NioApp, $) {
    ...
    var profileBalance = {
        ...
        datasets : [{
            ...
            color : "#F0D854",
            background : NioApp.hexRGB('#F0D854',.3),
    ...
    var salesRevenue = {
        ...
        datasets : [{
            label : "Sales Revenue",
            color : [NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2), NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),"#F0D854"],
    ...
    var activeSubscription = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),NioApp.hexRGB("#F0D854", .2),"#F0D854"],
