...
!(function (NioApp, $) {
    ...
    // init chart
    NioApp.coms.docReady.push(function () { enrolementChart(); });
    ...
    // init chart
    NioApp.coms.docReady.push(function () { courseProgressChart(); });
    ...
    var TrafficChannelDoughnutData = {
        ...
        datasets: [{
            borderColor: "#fff",
            background: ["#F0D854", "#b8acff", "#ffa9ce", "#f9db7b"],
...
var totalSales = {
    ...
    datasets: [{
        label: "Sales",
        color: "#F0D854",
        background: NioApp.hexRGB('#F0D854', .25),
...
// init chart
NioApp.coms.docReady.push(function () { lmsLineS1(); });
...
// init chart
NioApp.coms.docReady.push(function () { lmsLineS4(); });
...
// init chart
NioApp.coms.docReady.push(function () { lmsDoughnutS1(); });
